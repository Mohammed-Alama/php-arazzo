...
it('rejects async fields on 1.0 doc at execution', function () {
    ...
    $document = new ArazzoDocument('1.0.0', new \Alama\LaravelArazzo\Dto\Info('Title', null, null, '1.0.0'), [], [], new Components([], [], [], []), [], null, SpecVersion::V1_0);
...
it('accepts async fields on 1.1 doc', function () {
    ...
    $step = new Step(
        ...
        action: 'receive',
        channelPath: 'test/channel',
        correlationId: new \Alama\LaravelArazzo\Dto\Expression('$.foo'),
        parameters: [],
        requestBody: null,
        successCriteria: [],
        onSuccess: [],
    ...
    $document = new ArazzoDocument('1.0.0', new \Alama\LaravelArazzo\Dto\Info('Title', null, null, '1.1.0'), [], [], new Components([], [], [], []), [], null, SpecVersion::V1_1);
    $context = new WorkflowContext('def_1', [], [], [], 'test_wf', 'exec_1');
