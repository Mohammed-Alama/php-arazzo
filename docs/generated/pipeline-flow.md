...
| **ExecutionGraphFactory** | runner | `DefaultOpenApiExecutor`, `ResponseSchemaValidator`, `StepExecutor`, `StepOutputExtractor`, `WorkflowEngine`, `WorkflowExecutor` | — | — |
...
| **StepOutputExtractor** | runner | — | `ExecutionGraphFactory` | — |
