...
- [`docs/generated/package-contracts.md`](../generated/package-contracts.md) — per-package capability contract: public entry surface, cross-boundary value types, declared internal-intent
